...
\begin{figure}[htbp]
  ...
  \caption{Full system architecture of the FedMRI platform.
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.72\linewidth]%
    {figures/appendix/fedmri_use_case_diagram_1.png}
...
\begin{figure}[htbp]
  ...
  \caption{Sequence diagram for the Doctor scan upload
...
\begin{figure}[htbp]
  ...
  \caption{Entity-relationship diagram for the FedMRI
