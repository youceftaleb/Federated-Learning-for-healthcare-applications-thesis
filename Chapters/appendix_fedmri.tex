...
\begin{figure}[htbp]
  ...
  \caption[FedMRI platform actor diagram]{High-level actor diagram of the FedMRI platform.
...
\begin{figure}[htbp]
  ...
  \caption[FedMRI use case diagram]{UML use case diagram for the FedMRI platform.
...
\begin{figure}[htbp]
  ...
  \caption[Patient MRI upload sequence]{Sequence diagram for the patient MRI upload flow.
...
\begin{figure}[htbp]
  ...
  \caption[Researcher dataset access sequence]{Sequence diagram for the researcher dataset
    access flow.
...
\begin{figure}[htbp]
  ...
  \caption[Single-machine development deployment]{Development deployment on a single machine
    via Docker Compose.
...
\begin{figure}[htbp]
  ...
  \caption[Production multi-VM deployment]{Production deployment across six virtual machines.
...
\begin{table}[htbp]
  \centering
  \caption[FedMRI privacy guarantee layers]{Privacy guarantee layers in the FedMRI
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    ...
    \label{fig:ss-signup}
  \end{subfigure}
  \caption[Authentication screens]{Authentication screens. Users register with a role
...
\begin{figure}[htbp]
  ...
  \caption[Doctor portal --- Dashboard]{Doctor portal --- Dashboard.
...
\begin{figure}[htbp]
  ...
  \caption[Doctor portal --- Scan Upload and Analysis]{Doctor portal --- Scan Upload and Analysis.
...
\begin{figure}[htbp]
  ...
  \caption[Doctor portal --- Medical History Archive]{Doctor portal --- Medical History Archive.
...
\begin{figure}[htbp]
  ...
  \caption[Doctor portal --- Documentation]{Doctor portal --- Documentation.
...
\begin{figure}[htbp]
  ...
  \caption[Patient portal --- AI Assistant chat]{Patient portal --- AI Assistant chat.
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption[Researcher portal --- Dataset Management]{Researcher portal --- Dataset Management.
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption[Researcher portal --- Model Performance \& FL Insights]{Researcher portal --- Model Performance and FL Insights.
...
\begin{figure}[htbp]
  ...
  \caption[Researcher portal --- System Logs]{Researcher portal --- System Logs.
...
\begin{figure}[htbp]
  ...
  \caption[Application shell --- HTML body structure]{Application shell --- HTML body structure.
